 ...
 * 
 */
@Mod(modid = "boilerplate", name = "Boilerplate", version = "4.1.0", dependencies = "after:BuildCraft|Core; after:TConstruct; after:ForgeMultipart; after:MineFactoryReloaded")
