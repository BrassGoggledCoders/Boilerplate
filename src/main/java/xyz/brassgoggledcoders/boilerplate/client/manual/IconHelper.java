...
public final class IconHelper {
	...
	public static TextureAtlasSprite forName(TextureMap ir, String name) {
		return ir.registerSprite(new ResourceLocation(Utils.getCurrentMod().getPrefix() + name));
	}

	public static TextureAtlasSprite forName(TextureMap ir, String name, String dir) {
		return ir.registerSprite(new ResourceLocation(Utils.getCurrentMod().getPrefix() + dir + "/" + name));
	}
	 ...
	 */
	public static void renderIconIn3D(Tessellator tess, float p_78439_1_, float p_78439_2_, float p_78439_3_,
			float p_78439_4_, int width, int height, float thickness) {
