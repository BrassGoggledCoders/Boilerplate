...
public final class RenderHelper {
	...
	public static void drawGradientRect(int par1, int par2, float z, int par3, int par4, int par5, int par6) {
		...
		tessellator.getBuffer().pos(par1, par4, z).color(var12, var13, var14, var11).endVertex();
		tessellator.getBuffer().pos(par3, par4, z).color(var12, var13, var14, var11).endVertex();
		tessellator.draw();
