...
import xyz.brassgoggledcoders.boilerplate.lib.client.manual.GuiLexiconEntry;
...
import xyz.brassgoggledcoders.boilerplate.lib.common.manual.LexiconRecipeMappings;
import xyz.brassgoggledcoders.boilerplate.lib.common.manual.LexiconRecipeMappings.EntryData;
...
public class PageRecipe extends LexiconPage {
	...
	public void renderScreen(IGuiLexiconEntry gui, int mx, int my) {
		...
		if(tooltipStack != null) {
			...
			if(tooltipEntry) {
				xyz.brassgoggledcoders.boilerplate.lib.client.manual.RenderHelper.renderTooltipOrange(mx, my + tooltipY, Collections.singletonList(EnumChatFormatting.GRAY + StatCollector.translateToLocal("botaniamisc.clickToRecipe")));
				tooltipY += 18;
			}

			if(tooltipContainerStack != null)
				xyz.brassgoggledcoders.boilerplate.lib.client.manual.RenderHelper.renderTooltipGreen(mx, my + tooltipY, Arrays.asList(EnumChatFormatting.AQUA + StatCollector.translateToLocal("botaniamisc.craftingContainer"), tooltipContainerStack.getDisplayName()));
		}
